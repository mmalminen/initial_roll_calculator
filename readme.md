...
### How to use:
 ...
 that would yield a "Throw value" of 0, allowing you to optionally roll with real dice. Set
 the result of dice rolls using the "Throw value" dropdown menu before clicking "Roll d20".
